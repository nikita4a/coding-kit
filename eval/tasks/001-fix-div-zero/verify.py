...
def main() -> int:
    ...
    # 0. AST audit: reject implementation introspection and require a real
    #    behavioral regression test before any behavior or mutation check.
